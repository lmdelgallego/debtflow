...
import { DollarSign, CreditCard, Wallet, HandCoins, LayoutDashboard } from 'lucide-react';
...
const Dashboard = () => {
  ...
  const cashFlowTrend: 'positive' | 'negative' | 'neutral' =
    cashFlow > 0 ? 'positive' : cashFlow < 0 ? 'negative' : 'neutral';
        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <SummaryCard
              ...
              size="hero"
              trend={cashFlowTrend}
              hint="Ingresos − Gastos este período"
            />
            <SummaryCard
              label="Deuda Total"
              value={totalDebt}
