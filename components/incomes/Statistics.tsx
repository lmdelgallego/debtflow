    ...
    <Card className="p-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        <div className="p-4 rounded-lg bg-muted/50">
          ...
          <p className="text-lg font-bold text-primary">${averageFixed.toLocaleString()}</p>
        </div>
        <div className="p-4 rounded-lg bg-muted/50">
          <p className="text-xs text-muted-foreground">Promedio Variables</p>
          <p className="text-lg font-bold text-accent">${averageVariable.toLocaleString()}</p>
        </div>
        <div className="p-4 rounded-lg bg-muted/50">
          <p className="text-xs text-muted-foreground">Ingreso Máximo</p>
          <p className="text-lg font-bold text-secondary">${maxIncome.toLocaleString()}</p>
        </div>
        <div className="p-4 rounded-lg bg-muted/50">
          <p className="text-xs text-muted-foreground">Ingreso Mínimo</p>
          <p className="text-lg font-bold">${minIncome.toLocaleString()}</p>
        </div>
        <div className="p-4 rounded-lg bg-muted/50">
